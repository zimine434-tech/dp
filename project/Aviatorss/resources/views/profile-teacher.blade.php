            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('news.my') }}" class="block bg-indigo-50 rounded-lg p-4 border border-indigo-200 transition hover:shadow-sm hover:bg-indigo-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400">
                        ...
                        <a href="{{ route('competitions.my') }}" class="block bg-green-50 rounded-lg p-4 border border-green-200 transition hover:shadow-sm hover:bg-green-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400">
                            <div class="flex items-center">
                        ...
                        <a href="{{ route('sports.my') }}" class="block bg-purple-50 rounded-lg p-4 border border-purple-200 transition hover:shadow-sm hover:bg-purple-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400">
                            <div class="flex items-center">
