        ...
        <div class="bg-white shadow-lg rounded-lg">
            ...
            <form action="{{ route('training-sessions.update', $trainingSession) }}" method="POST" class="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-visible">
                ...
                <div>
                    ...
                    <x-filter-combobox
                        name="team_id"
                        :selected="old('team_id', $trainingSession->team_id)"
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        maxlength="200"
                        class="wysiwyg w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('title') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button 
                            ...
                            class="wysiwyg w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('locations_id') border-red-500 @enderror bg-white text-left flex items-center justify-between"
