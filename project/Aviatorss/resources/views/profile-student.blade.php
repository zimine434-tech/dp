    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <!-- Статистика (можно расширить позже) -->
                <div>
                    <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b">Статистика</h2>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <a
                            href="{{ route('profile.participations.teams') }}"
                            class="bg-blue-50 rounded-lg p-4 border border-blue-200 block transition hover:shadow-md hover:border-blue-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                            aria-label="История участия в командах"
                        >
                        ...
                        <a
                            href="{{ route('profile.participations.competitions') }}"
                            class="bg-green-50 rounded-lg p-4 border border-green-200 block transition hover:shadow-md hover:border-green-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-2"
                            aria-label="Завершённые соревнования, в которых вы участвовали"
                        >
                            <div class="flex items-center">
                        ...
                        <a
                            href="{{ route('profile.participations.trainings') }}"
                            class="bg-purple-50 rounded-lg p-4 border border-purple-200 block transition hover:shadow-md hover:border-purple-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-600 focus-visible:ring-offset-2"
                            aria-label="История завершённых тренировок"
                        >
                            <div class="flex items-center">
                        ...
                        <a
                            href="{{ route('profile.portfolio') }}"
                            class="bg-yellow-50 rounded-lg p-4 border border-yellow-200 block transition hover:shadow-md hover:border-yellow-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-600 focus-visible:ring-offset-2"
                            aria-label="Портфолио с занятыми местами"
                        >
                            <div class="flex items-center">
                                <svg class="w-8 h-8 text-yellow-700 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <div class="min-w-0">
                                    <p class="text-sm text-gray-600">Портфолио</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ (int) ($portfolioCount ?? 0) }}</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                <strong>Внимание:</strong> Данные в личном кабинете доступны только для просмотра. Для изменения информации обратитесь к администратору.
                            </p>
                        </div>
                    </div>
                </div>
