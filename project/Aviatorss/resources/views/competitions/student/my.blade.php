    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3 lg:flex-row lg:items-stretch lg:gap-4">
            <div class="flex min-w-0 flex-1 flex-col">
                ...
                <form id="competitions-student-my-filters-form" method="GET" action="{{ route('competitions.student.my') }}" class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:flex-nowrap lg:items-end lg:gap-4">
                        ...
                        <div class="w-full min-w-0 shrink-0 lg:w-48 xl:w-52">
                            <label for="comp_my_category_combobox_trigger" class="mb-1 block text-sm font-medium text-gray-700">Категория</label>
                            <x-filter-combobox
                                name="competition_category_id"
                                :selected="$lf['competition_category_id'] ?? ''"
                                :options="$categoryFilterOptions"
                                empty-label="Все категории"
                                input-id="comp_my_category"
                                variant="filter"
                            />
                        </div>
                ...
                <div id="competitions-student-my-sort-hidden-inputs" class="hidden" aria-hidden="true">
        ...
        @include('competitions.student.partials.listing-ajax-region', [
            'listingPage' => 'my',
            'listingRoute' => 'competitions.student.my',
            'filter' => $filter,
            'listingFilters' => $listingFilters,
            ...
            'perPageSelectId' => 'comp_my_per_page_select',
            'perPageComboboxTriggerId' => 'comp_my_per_page_select_combobox_trigger',
        ])
    </div>
@endsection
...
@push('scripts')
    @include('competitions.student.partials.listing-ajax-scripts', [
        'formId' => 'competitions-student-my-filters-form',
        'viewHiddenId' => 'comp_my_filter_view',
        'perPageHiddenId' => 'comp_my_filter_per_page',
        'perPageSelectId' => 'comp_my_per_page_select',
        'sortHiddenWrapId' => 'competitions-student-my-sort-hidden-inputs',
        'sortStorageKey' => 'my',
    ])
@endpush
