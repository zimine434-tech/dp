...
class TeamController extends Controller
{
    ...
    {
        $listingFilters = $this->teamListingFilters($request);
        ...
        $teams = $this->teamListingQuery($listingFilters)
            ->with(['members.user', 'sport'])
            ->latest()
            ->paginate($perPage)
            ->withQueryString();
        ...
        return view('teams.teacher.index', compact('teams', 'perPage', 'listingFilters', 'sportsForFilter'));
    }
    ...
    public function indexStudent(Request $request)
    {
        ...
        return view('teams.student.index', compact('teams', 'perPage', 'listingFilters', 'sportsForFilter'));
    }

    /**
     * @return array{q: string, sport_id?: int|string|null}
     */
    private function teamListingFilters(Request $request): array
    {
    ...
    private function teamListingQuery(array $listingFilters)
    {
        $query = Team::query();
