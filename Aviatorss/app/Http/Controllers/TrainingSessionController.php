...
class TrainingSessionController extends Controller
{
    ...
    public function indexStudent(Request $request)
    {
        ...
        return view(
            ...
            compact('allTrainingSessions', 'filter', 'listingFilters', 'sportsForFilter', 'view', 'hasSearchFilters')
        );
    }
    ...
    public function showStudent(TrainingSession $trainingSession)
    {
        ...
        return view('training-sessions.student.show', compact('trainingSession'));
    }
